...
export default function HeaderWebDevSmallJp() {
    ...
    return(
        <section className="header-small-root">
            <div className="container-fluid">
                <div className="row">
                    <section className="header-small header-webdev-small">
                            ...
                            <div className="col-4">
                                <section className="logo-section-small d-flex">
                                    <Link href="/landing-jp">
                                        <img className="img logo-img-header-small-about landing-logo-small" src="/media/logos/WDoffwhite.png" alt="nonologo" />
                                    </Link>
                                </section>
                            </div>
                            ...
                            <section className="hamburger-small d-flex justify-content-end">
                                <div className="col-4">
                                    <div onClick={handleClick} className="burger-button">
                                        <span className={`burger-line webdev-burger-line`}></span>
                                        <span className={`burger-line webdev-burger-line`}></span>
                                        <span className={`burger-line webdev-burger-line`}></span>
                                    </div>
                                </div>
